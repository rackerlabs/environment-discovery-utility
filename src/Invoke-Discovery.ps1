<#
    ...
    .EXAMPLE
        Invoke-Discovery -Modules Exchange,AD,ExchangeOnline,AzureAD -OutputFolder c:\temp
...
param (
    ...
    # The credentials to use for connecting to Microsoft 365 and Azure Active Directory
...
Start-EnvironmentDiscovery -Modules $Modules -OutputFolder $OutputFolder -Verbose:$VerbosePreference -Debug:$DebugPreference -SkipDnsLookups:$SkipDnsLookups -CloudCredential $CloudCredential
