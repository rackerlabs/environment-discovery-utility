function Start-ActiveDirectoryDiscovery
{
    ...
    process
    {
        ...
        if ($forest)
        {
            ...
            $forestDetails = "" | Select-Object Name, Mode, RootDomain, SchemaRoleOwner, NamingRoleOwner, Schema, ApplicationPartitions, SiteLinks, Domains, Sites, OrganizationalUnits
